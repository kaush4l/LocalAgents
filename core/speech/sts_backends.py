...
from core.speech.stt_backends import (
    AudioTranscriberBaseModel,
    MacOSNativeLiveTranscriber,
    Qwen3ASRTranscriber,
    WhisperAPITranscriber,
)
from core.speech.stt_registry import STTRegistry
from core.speech.stt_registry import stt_registry as _default_stt_registry
from core.speech.tts_backends import (
    LocalModelSynthesizerBase,
    PlayableSynthesizerBase,
    Qwen3TTSSynthesizer,
    SpeechSynthesizerBaseModel,
)
from core.speech.tts_registry import TTSRegistry
from core.speech.tts_registry import tts_registry as _default_tts_registry
